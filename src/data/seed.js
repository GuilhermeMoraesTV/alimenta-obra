export const USERS = [
  { id: "u-admin", name: "Mariana Costa", role: "admin", email: "admin@alimentaobra.local", team: "Administração" },
  ...
  { id: "u-joao-pedro", name: "João Pedro", role: "encarregado", email: "joaopedro@obra.local", team: "Elétrica" },
...
export const MEAL_TYPES = [
  ...
  { id: "buffer-almoco", label: "Buffer Almoço", description: "Refeição servida em ponto de apoio ou restaurante.", active: true, locations: ["Restaurante BR", "Restaurante Centro"] },
  { id: "jantar", label: "Jantar", description: "Refeição noturna para equipes programadas.", active: true, locations: ["Restaurante Centro"] }
];
...
export const INITIAL_REQUESTS = [
  ...
  { id: "req-008", date: "2026-06-18", mealType: "Buffer Almoço", quantity: 35, location: "Restaurante BR", leaderId: "u-wiliam", status: "enviado", notes: "", createdAt: "2026-06-17T10:00:00-03:00", updatedAt: "2026-06-17T10:00:00-03:00" },
  { id: "req-009", date: "2026-06-18", mealType: "Buffer Almoço", quantity: 18, location: "Restaurante Centro", leaderId: "u-joaquim", status: "enviado", notes: "", createdAt: "2026-06-17T10:11:00-03:00", updatedAt: "2026-06-17T10:11:00-03:00" },
