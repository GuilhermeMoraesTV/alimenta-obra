const ICON_PATHS = {
  ...
  download: `<path d="M12 4.5v10"/><path d="m7.8 10.7 4.2 4.2 4.2-4.2"/><path d="M5.2 18.8h13.6"/>`,
  smartphone: `<rect x="7" y="3.5" width="10" height="17" rx="2.2"/><path d="M10.5 17.6h3"/>`,
  ...
  key: `<circle cx="7.8" cy="12.2" r="3.4"/><path d="M11.2 12.2h8.2"/><path d="M16.2 12.2v2.8"/><path d="M19.4 12.2v2"/>`,
