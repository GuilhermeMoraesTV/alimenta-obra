...
`;function j(e){let{consolidation:t,formatDate:n,getConsolidationSummary:r,icon:i,nextSupplierStep:a,STATUS_LABEL:s}=e,l=r(e.state,t),u=a(t.status),d=t.status===`cancelamento_pendente`,m=new Date(t.createdAt??t.sentAt??0).getTime(),h=Number.isFinite(m)&&(e.state.consolidations??[]).some(e=>{if(e.id===t.id||e.date!==t.date||e.supplierId!==t.supplierId||e.status===`rascunho`)return!1;let n=new Date(e.createdAt??e.sentAt??0).getTime();return Number.isFinite(n)&&n<m}),g=T(l.rows),_=l.rows.reduce((n,r)=>{let i=o(e.state,t.id,r);return n+Number(i??0)},0),v=[`saiu_entrega`,`entregue`,`cancelado_confirmado`].includes(t.status),y=v&&l.rows.some(n=>o(e.state,t.id,n)!==null),b=new Set(l.rows.map(e=>e.leaderId||e.createdBy)).size,x=new Set(l.rows.map(e=>e.teamId||e.sectionName||e.location)).size,C=t.sentAt?l.rows.filter(e=>e.updatedAt&&new Date(e.updatedAt)>new Date(t.sentAt)):[],w=t.status===`enviado`&&(C.length>0||(t.revisions?.length??0)>0);return(0,f.jsxs)(`article`,{className:`supplier-daily-block-card${h?` is-extra`:``}${d?` is-cancelled`:``}`,children:[(0,f.jsxs)(`header`,{className:`supplier-daily-block-head`,children:[(0,f.jsx)(`div`,{className:`supplier-daily-block-head-main`,children:(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`span`,{className:`compact-kicker`,children:h?`Pedido extra`:`Bloco diario`}),(0,f.jsx)(`h2`,{children:n(t.date)}),(0,f.jsxs)(`p`,{children:[l.rows.length,` pedidos - `,b,` encarregados - `,x,` equipes`]})]})}),h?(0,f.jsxs)(`span`,{className:`supplier-daily-extra-chip`,children:[(0,f.jsx)(p,{icon:i,name:`plus`,size:12}),`Pedido extra da data`]}):null]}),(0,f.jsx)(`div`,{className:`supplier-daily-block-body`,children:g.map(n=>(0,f.jsxs)(`section`,{className:`supplier-daily-meal-block`,children:[(0,f.jsxs)(`div`,{className:`supplier-daily-meal-title`,children:[(0,f.jsx)(`strong`,{children:n.label}),(0,f.jsx)(`span`,{children:n.total})]}),e.requestMealDescription?.(n.rows[0])?(0,f.jsx)(`div`,{className:`supplier-daily-meal-description`,children:e.requestMealDescription(n.rows[0])}):null,n.rows.map(n=>{let r=v?o(e.state,t.id,n):null;return(0,f.jsxs)(`div`,{className:`supplier-daily-request-row`,children:[(0,f.jsxs)(`div`,{className:`supplier-daily-request-title`,children:[(0,f.jsx)(`strong`,{children:E(e.state,n)}),(0,f.jsxs)(`small`,{children:[c(n),` - `,n.sectionName||n.location]})]}),(0,f.jsxs)(`div`,{className:`supplier-daily-request-qty`,children:[(0,f.jsx)(`strong`,{children:n.quantity}),r===null?null:(0,f.jsxs)(`small`,{children:[r,` cons.`]})]})]},n.id)})]},n.key))}),(0,f.jsxs)(`footer`,{className:`supplier-daily-block-footer`,children:[w?(0,f.jsxs)(`div`,{className:`supplier-daily-update-alert`,children:[(0,f.jsx)(p,{icon:i,name:`edit`,size:15}),(0,f.jsxs)(`div`,{children:[(0,f.jsx)(`strong`,{children:`Pedido atualizado pelo Admin`}),(0,f.jsx)(`span`,{children:`Confira quantidades e itens antes de confirmar recebimento.`})]})]}):null,d?(0,f.jsxs)(`div`,{className:`supplier-daily-cancel-note`,children:[(0,f.jsx)(`span`,{children:`Pedido cancelado pelo Admin`}),(0,f.jsx)(`strong`,{children:`Confirmar ciencia`})]}):null,(0,f.jsx)(`div`,{className:`supplier-daily-final-summary`,children:g.map(e=>(0,f.jsxs)(`div`,{className:`supplier-daily-final-row`,children:[(0,f.jsx)(`span`,{children:e.label}),(0,f.jsx)(`strong`,{children:e.total})]},e.key))}),y?(0,f.jsxs)(`div`,{className:`supplier-daily-total-line`,children:[(0,f.jsx)(`span`,{children:`Consumo real`}),(0,f.jsxs)(`strong`,{children:[_,` refeicoes`]})]}):null,(0,f.jsxs)(`div`,{className:`supplier-daily-total-line`,children:[(0,f.jsx)(`span`,{children:h?`Total do extra`:`Total do dia`}),(0,f.jsxs)(`strong`,{children:[l.total,` refeicoes`]})]}),(0,f.jsx)(`div`,{className:`supplier-daily-actions`,children:u?(0,f.jsxs)(`button`,{className:`btn primary small`,"data-step":u.step,"data-id":t.id,children:[(0,f.jsx)(p,{icon:i,name:u.iconName??`check`,size:15}),u.label]}):(0,f.jsx)(`span`,{className:`badge ${t.status}`,children:S(s,t.status)})})]})]})}function M(e){if(arguments.length>0&&!e)return``;let t=e instanceof Date?e:new Date(arguments.length?e:void 0);return Number.isNaN(t.getTime())?``:`${t.getFullYear()}-${String(t.getMonth()+1).padStart(2,`0`)}-${String(t.getDate()).padStart(2,`0`)}`}function N(e){let{formatDate:t,getConsolidationSummary:n,icon:r,state:i,user:a}=e,o=y(i,a),s=M(),c=o.filter(e=>e.status!==`rascunho`&&![`saiu_entrega`,`entregue`,`cancelado_confirmado`].includes(e.status)),l=c.reduce((e,t)=>e+n(i,t).total,0),u=x(o,`enviado`),m=x(o,`confirmado`)+x(o,`producao`),h=x(o,`saiu_entrega`)+x(o,`entregue`);return(0,f.jsxs)(`section`,{className:`supplier-dashboard`,children:[(0,f.jsx)(`style`,{children:A}),(0,f.jsx)(g,{className:`supplier-home-receipt`,kicker:`Recebidos em tempo real - ${t(s)}`,title:`Visao operacional`,totalValue:u,totalLabel:`pedidos a confirmar`,description:`Pedidos enviados pelo Admin aparecem aqui assim que chegam ao fornecedor.`,actions:(0,f.jsxs)(`button`,{className:`btn primary`,"data-view":`fornecedor-pedidos`,children:[(0,f.jsx)(p,{icon:r,name:`clipboard`,size:15}),`Ver todos`]}),metrics:[{icon:r,iconName:`utensils`,label:`Refeicoes ativas`,value:l},{icon:r,iconName:`clipboard`,label:`A confirmar`,value:u},{icon:r,iconName:`clock`,label:`Prontos p/ saida`,value:m},{icon:r,iconName:`check`,label:`Saidas`,value:h}]}),c.length?(0,f.jsx)(`div`,{className:`supplier-daily-block-list`,children:c.map(t=>(0,d.createElement)(j,{...e,consolidation:t,key:t.id}))}):(0,f.jsx)(`div`,{className:`empty`,children:`Nenhum pedido ativo no momento. Assim que o Admin enviar, ele aparece aqui em tempo real.`})]})}function P(e){let{formatDate:t,formatDateTime:n,getConsolidationSummary:r,icon:i,requestMealDescription:a,selectedSupplierConsolidationId:o,state:s,supplierOrderDate:c,supplierOrderStatus:l,STATUS_LABEL:u,user:d}=e,p=y(s,d).filter(e=>(l===`todos`||(l===`ativos`?![`saiu_entrega`,`entregue`,`rascunho`,`cancelado_confirmado`].includes(e.status):e.status===l))&&(!c||e.date===c)),m=p.filter(e=>![`saiu_entrega`,`entregue`,`rascunho`,`cancelado_confirmado`].includes(e.status)),h=p.reduce((e,t)=>e+r(s,t).total,0),v=x(p,`enviado`),b=p.find(e=>e.id===o)??null,C=b?r(s,b):null;return(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(`style`,{children:`
        ${A}
...
`;function V(e){let t;return t=e.page===`fornecedor-pedidos`?(0,f.jsx)(P,{...e}):e.page===`fornecedor-historico`?(0,f.jsx)(F,{...e}):e.page===`fornecedor-mais`?(0,f.jsx)(I,{...e}):e.page===`fornecedor-documentos`?(0,f.jsx)(L,{...e}):e.page===`fornecedor-financeiro`?(0,f.jsx)(z,{...e}):(0,f.jsx)(N,{...e}),(0,f.jsxs)(f.Fragment,{children:[(0,f.jsx)(`style`,{children:B}),(0,f.jsx)(`div`,{className:`supplier-page`,children:t})]})}var H=new WeakMap;function U(e=document){e.querySelectorAll(`[data-supplier-react-root]`).forEach(e=>{let t=H.get(e);t&&(t.unmount(),H.delete(e))})}function W(e,t){let n=e.querySelector(`[data-supplier-react-root]`);if(!n)return;let r=H.get(n);r||(r=(0,u.createRoot)(n),H.set(n,r)),(0,l.flushSync)(()=>{r.render((0,f.jsx)(V,{...t}))})}export{W as mountSupplierReactPage,U as unmountSupplierReactPage};