...
`;function L(e){let{formatDate:t,icon:n,money:r,requestValue:i,state:a,sumQty:o,STATUS_LABEL:s}=e,c=new Set((a.consolidations??[]).filter(e=>e.status===`cancelado_confirmado`).flatMap(e=>e.requestIds??[])),l=a.requests.filter(e=>e.status!==`cancelado`&&!c.has(e.id)),u=a.settings.defaultMealDate.slice(0,7),d=l.filter(e=>e.date.startsWith(u)),f=d.filter(e=>e.status===`entregue`),p=d.reduce((e,t)=>e+i(t),0),m=f.reduce((e,t)=>e+i(t),0),_=p-m,b=o(d),x=a.mealTypes.map(e=>({label:e.label,value:d.filter(t=>t.mealTypeId===e.id).reduce((e,t)=>e+i(t),0)})).filter(e=>e.value>0),C=Math.max(...x.map(e=>e.value),1),w=Array.from({length:7},(e,t)=>{let n=new Date(`${a.settings.defaultMealDate}T12:00:00`);n.setDate(n.getDate()-(6-t));let r=n.toISOString().slice(0,10);return{key:r,label:String(n.getDate()).padStart(2,`0`),value:l.filter(e=>e.date===r).reduce((e,t)=>e+i(t),0)}}),T=Math.max(...w.map(e=>e.value),1),E=[...d].sort((e,t)=>t.date.localeCompare(e.date));return(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(`style`,{children:F+I}),(0,h.jsxs)(`section`,{className:`finance-page`,children:[(0,h.jsx)(v,{kicker:`Financeiro`,title:`Financeiro`,totalValue:r(p),totalLabel:`previsto em ${u}`,description:`Custos, entregas e pendencias do mes.`,actions:(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(y,{icon:n}),(0,h.jsxs)(`button`,{className:`btn primary`,"data-export-finance":`admin`,children:[(0,h.jsx)(g,{icon:n,name:`chart`,size:15}),`Gerar PDF`]})]}),metrics:[{icon:n,iconName:`chart`,label:`Custo previsto`,value:r(p)},{icon:n,iconName:`truck`,label:`Pago/entregue`,value:r(m)},{icon:n,iconName:`clock`,label:`Em aberto`,value:r(_)},{icon:n,iconName:`utensils`,label:`Ticket medio`,value:r(b?p/b:0)}]}),null,(0,h.jsxs)(`div`,{className:`mt-2 grid gap-3 lg:grid-cols-2`,children:[(0,h.jsxs)(`article`,{className:`group relative overflow-hidden rounded-2xl border border-l-2 border-dashed border-stone-300 bg-white p-5 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md`,children:[(0,h.jsx)(`h2`,{className:`mb-4 text-xs font-black uppercase tracking-widest text-stone-800`,children:`Composição por Refeição`}),(0,h.jsxs)(`div`,{className:`grid gap-3`,children:[x.map(e=>(0,h.jsxs)(`div`,{className:`flex flex-col gap-1.5 rounded-lg border border-stone-100 bg-stone-50 p-3 transition-colors hover:border-blue-200 hover:bg-blue-50/40`,children:[(0,h.jsxs)(`div`,{className:`flex items-center justify-between text-xs font-bold text-stone-600`,children:[(0,h.jsx)(`span`,{className:`uppercase tracking-wider`,children:e.label}),(0,h.jsx)(`strong`,{className:`text-blue-700`,children:r(e.value)})]}),(0,h.jsx)(`div`,{className:`h-1.5 w-full overflow-hidden rounded-full bg-stone-200`,children:(0,h.jsx)(`div`,{className:`h-full rounded-full bg-blue-600 transition-all duration-700 ease-out`,style:{width:`${Math.max(3,Math.round(e.value/C*100))}%`}})})]},e.label)),!x.length&&(0,h.jsx)(`div`,{className:`rounded-lg border border-dashed border-stone-300 bg-stone-50 p-6 text-center text-sm font-bold text-stone-500`,children:`Sem movimentação no período.`})]})]}),(0,h.jsxs)(`article`,{className:`group relative overflow-hidden rounded-2xl border border-l-2 border-dashed border-stone-300 bg-white p-5 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md`,children:[(0,h.jsx)(`h2`,{className:`mb-4 text-xs font-black uppercase tracking-widest text-stone-800`,children:`Evolução dos últimos 7 dias`}),(0,h.jsx)(`div`,{className:`flex h-44 items-end justify-between gap-1 rounded-xl border border-stone-100 bg-stone-50 p-3 sm:gap-2`,children:w.map(e=>(0,h.jsxs)(`div`,{className:`group/bar relative flex h-full w-full flex-col items-center justify-end gap-1`,children:[(0,h.jsx)(`div`,{className:`absolute -top-7 left-1/2 -translate-x-1/2 opacity-0 transition-all duration-300 group-hover/bar:-translate-y-1 group-hover/bar:opacity-100`,children:(0,h.jsx)(`span`,{className:`whitespace-nowrap rounded bg-stone-800 px-2 py-1 text-[10px] font-bold text-white shadow-lg`,children:e.value?r(e.value).replace(`R$`,``):`0,00`})}),(0,h.jsx)(`div`,{className:`relative flex w-full max-w-[2.5rem] flex-1 items-end justify-center rounded-t-md bg-stone-200/50 transition-colors group-hover/bar:bg-stone-200`,children:(0,h.jsx)(`div`,{className:`w-full rounded-t-md bg-stone-400 transition-all duration-700 ease-out group-hover/bar:bg-red-600`,style:{height:`${Math.max(5,Math.round(e.value/T*100))}%`}})}),(0,h.jsx)(`span`,{className:`text-[10px] font-black text-stone-500`,children:e.label})]},e.key))})]})]}),(0,h.jsxs)(`article`,{className:`overflow-hidden rounded-2xl border border-l-2 border-dashed border-stone-300 bg-white p-5 shadow-sm transition-all hover:shadow-md`,children:[(0,h.jsx)(`h2`,{className:`mb-4 text-xs font-black uppercase tracking-widest text-stone-800`,children:`Movimentações do Período`}),(0,h.jsxs)(`div`,{className:`finance-mobile-movements`,children:[E.map(e=>(0,h.jsxs)(`article`,{className:`finance-mobile-row`,children:[(0,h.jsxs)(`div`,{className:`finance-mobile-row-top`,children:[(0,h.jsxs)(`div`,{children:[(0,h.jsx)(`h3`,{children:e.mealType}),(0,h.jsx)(`time`,{children:t(e.date)})]}),(0,h.jsx)(`span`,{className:`badge ${e.status}`,children:S(s,e.status)})]}),(0,h.jsxs)(`div`,{className:`finance-mobile-row-meta`,children:[(0,h.jsxs)(`span`,{children:[`Quantidade`,(0,h.jsx)(`strong`,{children:e.quantity})]}),(0,h.jsxs)(`span`,{children:[`Valor`,(0,h.jsx)(`strong`,{children:r(i(e))})]})]})]},e.id)),!E.length&&(0,h.jsx)(`div`,{className:`empty`,children:`Nenhuma movimentacao encontrada para o periodo.`})]}),(0,h.jsx)(`div`,{className:`finance-desktop-movements overflow-x-auto rounded-xl border border-stone-200 bg-stone-50 shadow-inner`,children:(0,h.jsxs)(`table`,{className:`w-full min-w-[600px] text-left text-sm`,children:[(0,h.jsx)(`thead`,{className:`border-b border-stone-200 bg-stone-100 text-[10px] uppercase tracking-widest text-stone-500`,children:(0,h.jsxs)(`tr`,{children:[(0,h.jsx)(`th`,{className:`px-5 py-3.5 font-black`,children:`Data`}),(0,h.jsx)(`th`,{className:`px-5 py-3.5 font-black`,children:`Tipo`}),(0,h.jsx)(`th`,{className:`px-5 py-3.5 text-center font-black`,children:`Qtd`}),(0,h.jsx)(`th`,{className:`px-5 py-3.5 font-black`,children:`Valor`}),(0,h.jsx)(`th`,{className:`px-5 py-3.5 font-black`,children:`Status`})]})}),(0,h.jsxs)(`tbody`,{className:`divide-y divide-stone-100 bg-white`,children:[E.map(e=>(0,h.jsxs)(`tr`,{className:`group/row cursor-default transition-colors hover:bg-stone-50`,children:[(0,h.jsx)(`td`,{className:`px-5 py-3.5 font-medium text-stone-500`,children:t(e.date)}),(0,h.jsx)(`td`,{className:`px-5 py-3.5 font-bold text-stone-700`,children:e.mealType}),(0,h.jsx)(`td`,{className:`px-5 py-3.5 text-center font-bold text-stone-600`,children:e.quantity}),(0,h.jsx)(`td`,{className:`px-5 py-3.5 font-black text-stone-900 transition-colors group-hover/row:text-blue-700`,children:r(i(e))}),(0,h.jsx)(`td`,{className:`px-5 py-3.5`,children:(0,h.jsx)(`span`,{className:`badge ${e.status}`,children:S(s,e.status)})})]},e.id)),!d.length&&(0,h.jsx)(`tr`,{children:(0,h.jsx)(`td`,{colSpan:`5`,className:`px-5 py-8 text-center text-sm font-bold text-stone-500`,children:`Nenhuma movimentação encontrada para o período.`})})]})]})})]})]})]})}var R=`
  .admin-page {
    width: 100%;
    max-width: 80rem;
    margin: 0 auto;
...
`,B=[`#ea580c`,`#1c1917`,`#0f766e`,`#2563eb`,`#a16207`,`#7c3aed`,`#be123c`,`#64748b`],V=[`Dom`,`Seg`,`Ter`,`Qua`,`Qui`,`Sex`,`Sab`];function H(e,t=100){return!Number.isFinite(e)||e<=0?0:Math.min(t,Math.max(0,e))}function U(e){return new Intl.NumberFormat(`pt-BR`,{maximumFractionDigits:0}).format(Number(e??0))}function W(e){return new Intl.NumberFormat(`pt-BR`,{style:`currency`,currency:`BRL`}).format(Number(e??0))}function me(e){if(!e)return`-`;let[,t,n]=String(e).split(`-`);return t&&n?`${n}/${t}`:String(e)}function he(e,t){let n=e.consolidationActuals?.find(e=>e.date===t.date&&e.teamId===t.teamId&&e.mealTypeId===t.mealTypeId);return Number(n?.quantity??t.actualQuantity??t.quantity??0)}function ge(e,t){return Number(t.sectionHeadcount??t.headcount??e.workSections?.find(e=>e.id===t.teamId)?.headcount??0)}function _e(e,t){let n=e.supplierMealTypes?.find(e=>e.supplierCompanyId===t.supplierCompanyId&&e.mealTypeId===t.mealTypeId);return Number(n?.unitPrice??t.unitPrice??e.mealCatalog?.find(e=>e.id===t.mealTypeId)?.unitPrice??e.settings?.defaultMealUnitPrice??0)}function ve(e,t,n={}){let r=t.reduce((t,r)=>{let i=Number(r.quantity??0),a=he(e,r),o=ge(e,r),s=a*_e(e,r),c=r.mealType||`Sem tipo`,l=r.sectionName||r.location||`Sem equipe`,u=n[r.status]??r.status??`Sem status`;t.requested+=i,t.consumed+=a,t.effective+=o,t.value+=s,t.byMeal[c]??={label:c,requested:0,consumed:0,effective:0,value:0},t.byMeal[c].requested+=i,t.byMeal[c].consumed+=a,t.byMeal[c].effective+=o,t.byMeal[c].value+=s,t.bySection[l]??={label:l,requested:0,consumed:0,effective:0,value:0},t.bySection[l].requested+=i,t.bySection[l].consumed+=a,t.bySection[l].effective+=o,t.bySection[l].value+=s,t.byStatus[u]??={label:u,value:0},t.byStatus[u].value+=1,t.byDay[r.date]??={label:me(r.date),date:r.date,requested:0,consumed:0,effective:0,value:0},t.byDay[r.date].requested+=i,t.byDay[r.date].consumed+=a,t.byDay[r.date].effective+=o,t.byDay[r.date].value+=s;let d=V[new Date(`${r.date}T12:00:00`).getDay()]??`-`;return t.heatmap[d]??={},t.heatmap[d][c]=(t.heatmap[d][c]??0)+a,t},{requested:0,consumed:0,effective:0,value:0,byMeal:{},bySection:{},byStatus:{},byDay:{},heatmap:{}});return{...r,meals:Object.values(r.byMeal).sort((e,t)=>t.consumed-e.consumed),sections:Object.values(r.bySection).sort((e,t)=>t.consumed-e.consumed),statuses:Object.values(r.byStatus).sort((e,t)=>t.value-e.value),days:Object.values(r.byDay).sort((e,t)=>e.date.localeCompare(t.date))}}function G({children:e,className:t=``,kicker:n,title:r,subtitle:i,chip:a}){return(0,h.jsxs)(`article`,{className:`report-chart-card ${t}`.trim(),children:[(0,h.jsxs)(`header`,{className:`report-chart-head`,children:[(0,h.jsxs)(`div`,{children:[n?(0,h.jsx)(`span`,{className:`compact-kicker`,children:n}):null,(0,h.jsx)(`h2`,{children:r}),i?(0,h.jsx)(`p`,{children:i}):null]}),a?(0,h.jsx)(`span`,{className:`report-chart-chip`,children:a}):null]}),e]})}function K(){return(0,h.jsx)(`div`,{className:`report-empty`,children:`Sem dados suficientes no periodo filtrado.`})}function q({items:e,valueKey:t=`value`,format:n=U,limit:r=8}){let i=e.slice(0,r),a=Math.max(...i.map(e=>Number(e[t]??0)),1);return i.length?(0,h.jsx)(`div`,{className:`report-bars`,children:i.map((e,r)=>{let i=Number(e[t]??0);return(0,h.jsxs)(`div`,{className:`report-bar-row`,children:[(0,h.jsx)(`span`,{className:`report-bar-label`,title:e.label,children:e.label}),(0,h.jsx)(`span`,{className:`report-bar-track`,children:(0,h.jsx)(`b`,{className:`report-bar-fill`,style:{"--bar-color":B[r%B.length],width:`${H(i/a*100)}%`}})}),(0,h.jsx)(`span`,{className:`report-bar-value`,children:n(i)})]},e.label)})}):(0,h.jsx)(K,{})}function ye({items:e}){let t=e.slice(0,7),n=Math.max(...t.flatMap(e=>[e.requested,e.consumed,e.effective]).map(Number),1);return t.length?(0,h.jsx)(`div`,{className:`report-grouped-bars`,children:t.map(e=>(0,h.jsxs)(`div`,{className:`report-group-row`,children:[(0,h.jsx)(`span`,{className:`report-bar-label`,title:e.label,children:e.label}),(0,h.jsxs)(`div`,{className:`report-group-stack`,children:[(0,h.jsx)(`span`,{className:`report-mini-track`,title:`Solicitado: ${e.requested}`,children:(0,h.jsx)(`b`,{style:{background:`#ea580c`,width:`${H(e.requested/n*100)}%`}})}),(0,h.jsx)(`span`,{className:`report-mini-track`,title:`Consumido: ${e.consumed}`,children:(0,h.jsx)(`b`,{style:{background:`#1c1917`,width:`${H(e.consumed/n*100)}%`}})}),(0,h.jsx)(`span`,{className:`report-mini-track`,title:`Efetivo: ${e.effective||0}`,children:(0,h.jsx)(`b`,{style:{background:`#0f766e`,width:`${H((e.effective||0)/n*100)}%`}})})]})]},e.label))}):(0,h.jsx)(K,{})}function J({items:e,center:t}){let n=e.filter(e=>Number(e.value??e.consumed??0)>0).slice(0,7),r=n.reduce((e,t)=>e+Number(t.value??t.consumed??0),0);if(!n.length||!r)return(0,h.jsx)(K,{});let i=0,a=n.map((e,t)=>{let n=Number(e.value??e.consumed??0),a=i+n/r*100,o=`${B[t%B.length]} ${i}% ${a}%`;return i=a,o}).join(`, `);return(0,h.jsxs)(`div`,{className:`report-donut-wrap`,children:[(0,h.jsx)(`div`,{className:`report-donut`,"data-center":t??U(r),style:{"--donut-stops":a}}),(0,h.jsx)(`div`,{className:`report-legend`,children:n.map((e,t)=>{let n=Number(e.value??e.consumed??0);return(0,h.jsxs)(`div`,{className:`report-legend-row`,children:[(0,h.jsx)(`span`,{className:`report-legend-dot`,style:{"--dot-color":B[t%B.length]}}),(0,h.jsx)(`span`,{className:`report-bar-label`,title:e.label,children:e.label}),(0,h.jsx)(`strong`,{children:U(n)})]},e.label)})})]})}function Y({items:e,valueKey:t=`consumed`,format:n=U,limit:r=14}){let i=e.slice(-r),a=Math.max(...i.map(e=>Number(e[t]??0)),1);return i.length?(0,h.jsx)(`div`,{className:`report-column-chart`,children:i.map(e=>{let r=Number(e[t]??0);return(0,h.jsxs)(`div`,{className:`report-column`,title:`${e.label}: ${n(r)}`,children:[(0,h.jsx)(`strong`,{children:n(r)}),(0,h.jsx)(`i`,{style:{height:`${Math.max(4,r/a*100)}%`}}),(0,h.jsx)(`span`,{children:e.label})]},e.date??e.label)})}):(0,h.jsx)(K,{})}function be({meals:e,heatmap:t}){let n=e.slice(0,5).map(e=>e.label),r=Math.max(...Object.values(t).flatMap(e=>n.map(t=>Number(e[t]??0))),1);return n.length?(0,h.jsxs)(`div`,{className:`report-heatmap`,style:{"--heat-count":n.length},children:[(0,h.jsxs)(`div`,{className:`report-heat-row`,children:[(0,h.jsx)(`strong`,{children:`Dia`}),n.map(e=>(0,h.jsx)(`strong`,{title:e,children:e.split(` `)[0]},e))]}),V.map(e=>(0,h.jsxs)(`div`,{className:`report-heat-row`,children:[(0,h.jsx)(`strong`,{children:e}),n.map(n=>{let i=Number(t[e]?.[n]??0);return(0,h.jsx)(`span`,{className:`report-heat-cell`,style:{"--heat":`${H(i/r*82,82)}%`},children:i||`-`},n)})]},e))]}):(0,h.jsx)(K,{})}function xe({currentFilter:e,exportMenuOpen:t,icon:n,isAllPeriod:r,isCustomPeriod:i}){return(0,h.jsxs)(`div`,{className:`export-menu ${t===`relatorios`?`open`:``}`,children:[(0,h.jsxs)(`button`,{className:`btn outline small`,type:`button`,"data-export-toggle":`relatorios`,children:[(0,h.jsx)(g,{icon:n,name:`clipboard`,size:14}),`Medicao`]}),t===`relatorios`?(0,h.jsxs)(`div`,{className:`export-options`,children:[(0,h.jsxs)(`label`,{children:[(0,h.jsx)(`span`,{children:`Periodo`}),(0,h.jsxs)(`select`,{"data-report-range":!0,value:e.range,onChange:()=>{},children:[(0,h.jsx)(`option`,{value:`all`,children:`Todo periodo`}),(0,h.jsx)(`option`,{value:`day`,children:`Dia`}),(0,h.jsx)(`option`,{value:`week`,children:`Semana`}),(0,h.jsx)(`option`,{value:`month`,children:`Mes`}),(0,h.jsx)(`option`,{value:`custom`,children:`Periodo personalizado`})]})]}),(0,h.jsxs)(`label`,{children:[(0,h.jsx)(`span`,{children:`Inicio`}),(0,h.jsx)(`input`,{type:`date`,value:e.start||``,"data-report-start":!0,disabled:r,onChange:()=>{}})]}),(0,h.jsxs)(`label`,{children:[(0,h.jsx)(`span`,{children:`Fim`}),(0,h.jsx)(`input`,{type:`date`,value:e.end||e.start||``,"data-report-end":!0,disabled:!i,onChange:()=>{}})]}),(0,h.jsxs)(`button`,{type:`button`,"data-export":`pdf`,children:[(0,h.jsx)(g,{icon:n,name:`clipboard`,size:14}),`PDF`]}),(0,h.jsxs)(`button`,{type:`button`,"data-export":`xlsx`,children:[(0,h.jsx)(g,{icon:n,name:`chart`,size:14}),`Excel`]})]}):null]})}function Se(e=new Date){let t=e instanceof Date?e:new Date(e);return Number.isNaN(t.getTime())?``:new Date(t.getTime()-t.getTimezoneOffset()*6e4).toISOString().slice(0,10)}function Ce(e=Se()){let t=new Date(`${e}T12:00:00`);return t.setDate(t.getDate()-1),t.toISOString().slice(0,10)}function X(e){return e?new Intl.DateTimeFormat(`pt-BR`,{dateStyle:`short`}).format(new Date(`${e}T12:00:00`)):`-`}function we({icon:e,report:t,reportDate:n}){let r=!!t;return(0,h.jsxs)(`article`,{className:`daily-report-card ${r?`is-available`:`is-pending`}`,children:[(0,h.jsxs)(`div`,{className:`daily-report-main`,children:[(0,h.jsx)(`span`,{className:`daily-report-icon`,children:(0,h.jsx)(g,{icon:e,name:`clipboard`,size:22})}),(0,h.jsxs)(`div`,{className:`daily-report-copy`,children:[(0,h.jsx)(`span`,{className:`compact-kicker`,children:`Relatorio automatico do dia anterior`}),(0,h.jsx)(`h2`,{children:r?`Relatorio de ${X(n)} disponivel`:`Relatorio de ${X(n)} em geracao`}),(0,h.jsx)(`p`,{children:r?`Arquivo gerado pelo sistema e pronto para baixar em PDF ou Excel, sem envio automatico por e-mail.`:`O sistema tenta gerar automaticamente este arquivo ao abrir o Admin depois de 00:00.`})]}),(0,h.jsx)(`span`,{className:`daily-report-status`,children:r?`Disponivel`:`Pendente`})]}),(0,h.jsxs)(`div`,{className:`daily-report-actions`,children:[(0,h.jsxs)(`button`,{className:`btn primary`,type:`button`,"data-daily-report-download":`pdf`,"data-report-date":n,disabled:!r,children:[(0,h.jsx)(g,{icon:e,name:`clipboard`,size:15}),`PDF`]}),(0,h.jsxs)(`button`,{className:`btn outline`,type:`button`,"data-daily-report-download":`xlsx`,"data-report-date":n,disabled:!r,children:[(0,h.jsx)(g,{icon:e,name:`chart`,size:15}),`Excel`]})]})]})}function Te(e){let{icon:t,reportFilter:n,reportPeriodLabel:r,reportRows:i,state:a,sumQty:o,totalsByMeal:s}=e,c=i??a.requests.filter(e=>e.status!==`cancelado`),l=ve(a,c,e.STATUS_LABEL??{}),u=Ce(),d=a.dailyReports?.find(e=>e.date===u),f=n??{range:`all`,start:a.settings.defaultMealDate,end:a.settings.defaultMealDate},p=o(c),m=s(c),_=f.range===`all`,b=f.range===`custom`,S=l.requested?`${Math.round(l.consumed/l.requested*100)}%`:`-`,C=l.effective?`${Math.round(l.consumed/l.effective*100)}%`:`-`,w=l.consumed?W(l.value/l.consumed):W(0),T=(a.consolidations??[]).filter(e=>{if(e.status!==`cancelado_confirmado`)return!1;if(!f.start&&!f.end)return!0;let t=f.start||f.end,n=f.end||f.start;return e.date>=t&&e.date<=n}).length;return(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(`style`,{children:R+z}),(0,h.jsx)(v,{kicker:`Relatórios`,title:`Visão geral e desempenho`,totalValue:p,totalLabel:`refeições no período`,description:`Período: ${r??`Todo período`}`,actions:(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(y,{icon:t}),(0,h.jsxs)(x,{icon:t,children:[(0,h.jsxs)(`select`,{"data-report-range":!0,value:f.range,onChange:()=>{},children:[(0,h.jsx)(`option`,{value:`all`,children:`Todo periodo`}),(0,h.jsx)(`option`,{value:`day`,children:`Dia`}),(0,h.jsx)(`option`,{value:`week`,children:`Semana`}),(0,h.jsx)(`option`,{value:`month`,children:`Mes`}),(0,h.jsx)(`option`,{value:`custom`,children:`Período personalizado`})]}),(0,h.jsx)(`input`,{type:`date`,value:f.start||a.settings.defaultMealDate,"data-report-start":!0,"aria-label":b?`Inicio do periodo`:`Data de referencia`,disabled:_,onChange:()=>{}}),(0,h.jsx)(`input`,{type:`date`,value:f.end||f.start||a.settings.defaultMealDate,"data-report-end":!0,"aria-label":`Fim do periodo`,disabled:!b,onChange:()=>{}}),(0,h.jsxs)(`select`,{"data-report-supplier":!0,value:f.supplierCompanyId||``,onChange:()=>{},"aria-label":`Fornecedor`,children:[(0,h.jsx)(`option`,{value:``,children:`Todos fornecedores`}),(a.supplierCompanies??[]).map(e=>(0,h.jsx)(`option`,{value:e.id,children:e.tradeName||e.legalName},e.id))]}),(0,h.jsxs)(`select`,{"data-report-meal":!0,value:f.mealTypeId||``,onChange:()=>{},"aria-label":`Tipo de refeicao`,children:[(0,h.jsx)(`option`,{value:``,children:`Todas refeicoes`}),(a.mealCatalog??a.mealTypes??[]).map(e=>(0,h.jsx)(`option`,{value:e.id,children:e.label},e.id))]}),(0,h.jsxs)(`select`,{"data-report-team":!0,value:f.teamId||``,onChange:()=>{},"aria-label":`Efetivo ou local`,children:[(0,h.jsx)(`option`,{value:``,children:`Todos locais`}),(a.workSections??[]).map(e=>(0,h.jsx)(`option`,{value:e.id,children:e.name},e.id))]}),(0,h.jsxs)(`select`,{"data-report-origin":!0,value:f.originRole||``,onChange:()=>{},"aria-label":`Origem do pedido`,children:[(0,h.jsx)(`option`,{value:``,children:`Todas origens`}),(0,h.jsx)(`option`,{value:`admin`,children:`Admin`}),(0,h.jsx)(`option`,{value:`encarregado`,children:`Encarregado`})]})]}),(0,h.jsxs)(`button`,{className:`btn primary small`,type:`button`,"data-export-kpi":!0,children:[(0,h.jsx)(g,{icon:t,name:`chart`,size:14}),`KPI PDF`]}),(0,h.jsx)(xe,{currentFilter:f,exportMenuOpen:e.exportMenuOpen,icon:t,isAllPeriod:_,isCustomPeriod:b})]}),metrics:[{icon:t,iconName:`utensils`,label:`Refeições`,value:p},{icon:t,iconName:`clipboard`,label:`Pedidos`,value:c.length},{icon:t,iconName:`box`,label:`Marmitas`,value:m[`Marmita Campo`]??0},{icon:t,iconName:`utensils`,label:`Almoços`,value:m[`Buffer Almoço`]??m[`Buffer Almoco`]??0},{icon:t,iconName:`moon`,label:`Jantas`,value:m.Jantar??0},{icon:t,iconName:`trash`,label:`Cancel. confirm.`,value:T}]}),(0,h.jsx)(we,{icon:t,report:d,reportDate:u}),null,(0,h.jsxs)(`section`,{className:`report-analytics mt-3`,children:[(0,h.jsxs)(`div`,{className:`report-insights`,children:[(0,h.jsxs)(`article`,{className:`report-insight`,children:[(0,h.jsx)(`span`,{children:`Consumido real`}),(0,h.jsx)(`strong`,{children:U(l.consumed)}),(0,h.jsxs)(`p`,{children:[S,` do solicitado no filtro.`]})]}),(0,h.jsxs)(`article`,{className:`report-insight`,children:[(0,h.jsx)(`span`,{children:`Ocupacao`}),(0,h.jsx)(`strong`,{children:C}),(0,h.jsx)(`p`,{children:`Consumo comparado ao efetivo informado.`})]}),(0,h.jsxs)(`article`,{className:`report-insight`,children:[(0,h.jsx)(`span`,{children:`Custo estimado`}),(0,h.jsx)(`strong`,{children:W(l.value)}),(0,h.jsxs)(`p`,{children:[w,` por refeicao consumida.`]})]})]}),(0,h.jsxs)(`div`,{className:`report-chart-grid wide`,children:[(0,h.jsx)(G,{className:`is-emphasis`,kicker:`KPI operacional`,title:`Solicitado x consumido x efetivo`,subtitle:`Comparacao por tipo de refeicao, seguindo a mesma leitura do KPI em PDF.`,chip:`${l.meals.length} tipos`,children:(0,h.jsx)(ye,{items:l.meals})}),(0,h.jsx)(G,{kicker:`Distribuicao`,title:`Consumo por refeicao`,subtitle:`Participacao de cada alimentacao no total consumido.`,chip:U(l.consumed),children:(0,h.jsx)(J,{items:l.meals.map(e=>({label:e.label,value:e.consumed})),center:U(l.consumed)})})]}),(0,h.jsxs)(`div`,{className:`report-chart-grid`,children:[(0,h.jsx)(G,{kicker:`Status`,title:`Situacao dos pedidos`,subtitle:`Visao resumida do funil operacional, sem repetir a lista de pedidos.`,chip:`${c.length} pedidos`,children:(0,h.jsx)(J,{items:l.statuses,center:String(c.length)})}),(0,h.jsx)(G,{kicker:`Evolucao`,title:`Consumo diario`,subtitle:`Ultimos dias do periodo filtrado para identificar picos e quedas.`,chip:`${l.days.length} dias`,children:(0,h.jsx)(Y,{items:l.days})})]}),(0,h.jsxs)(`div`,{className:`report-chart-grid`,children:[(0,h.jsx)(G,{kicker:`Areas e trechos`,title:`Top equipes por consumo`,subtitle:`Frentes com maior volume operacional no periodo.`,chip:`ranking`,children:(0,h.jsx)(q,{items:l.sections,valueKey:`consumed`})}),(0,h.jsx)(G,{kicker:`Financeiro`,title:`Custo por refeicao`,subtitle:`Estimativa baseada no preco unitario cadastrado.`,chip:W(l.value),children:(0,h.jsx)(q,{items:l.meals,valueKey:`value`,format:W})})]}),(0,h.jsxs)(`div`,{className:`report-chart-grid wide`,children:[(0,h.jsx)(G,{kicker:`Capacidade`,title:`Ocupacao diaria`,subtitle:`Consumo real comparado ao efetivo das equipes/trechos.`,chip:C,children:(0,h.jsx)(Y,{items:l.days.map(e=>({...e,occupancy:e.effective?Math.round(e.consumed/e.effective*100):0})),valueKey:`occupancy`,format:e=>`${e}%`})}),(0,h.jsx)(G,{kicker:`Mapa de calor`,title:`Dia da semana x refeicao`,subtitle:`Concentracao de consumo por dia e tipo de alimentacao.`,chip:`heatmap`,children:(0,h.jsx)(be,{meals:l.meals,heatmap:l.heatmap})})]})]})]})}var Ee=`
  .admin-page {
    width: 100%;
    max-width: 80rem;
    margin: 0 auto;
...
`;function Me(e){let t;return t=e.page===`painel`?(0,h.jsx)(ae,{...e}):e.page===`pedidos`?(0,h.jsx)(ce,{...e}):e.page===`consolidacao`?(0,h.jsx)(P,{...e}):e.page===`financeiro`?(0,h.jsx)(L,{...e}):e.page===`relatorios`?(0,h.jsx)(Te,{...e}):e.page===`auditoria`?(0,h.jsx)(Oe,{...e}):(0,h.jsx)(Ae,{...e}),(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(`div`,{className:`admin-page`,children:t}),(0,h.jsx)(`style`,{children:je})]})}var $=new WeakMap;function Ne(e=document){e.querySelectorAll(`[data-admin-react-root]`).forEach(e=>{let t=$.get(e);t&&(t.unmount(),$.delete(e))})}function Pe(e,t){let n=e.querySelector(`[data-admin-react-root]`);if(!n)return;let r=$.get(n);r||(r=(0,p.createRoot)(n),$.set(n,r)),(0,f.flushSync)(()=>{r.render((0,h.jsx)(Me,{...t}))})}export{Pe as mountAdminReactPage,Ne as unmountAdminReactPage};