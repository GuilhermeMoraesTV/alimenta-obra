...
drop trigger if exists meal_requests_prevent_past_date on public.meal_requests;
create trigger meal_requests_prevent_past_date
before insert or update of meal_date on public.meal_requests
for each row execute function public.prevent_past_meal_request_date();
